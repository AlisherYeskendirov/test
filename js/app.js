    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            new core(".offer__slider", {
                ...
                navigation: {
                    prevEl: ".main-section-prev",
                    nextEl: ".main-section-next"
                },
                on: {}
            });
            new core(".images__slider", {
                modules: [ Navigation, Pagination, Autoplay, EffectFade ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            new core(".team-section__slider", {
                ...
                navigation: {
                    prevEl: ".team-section__left",
                    nextEl: ".team-section__right"
                }
            });
        }
    }
